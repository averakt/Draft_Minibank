...
Revision ID: 3f691fa00711
Revises: 834b1a697901
Create Date: 2023-09-26 20:46:16.532465
...
def upgrade():
    ...
    op.add_column('user', sa.Column('patronymic', sa.String(length=255), nullable=True))
