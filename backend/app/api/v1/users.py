...
def create_user():
    ...
    if 'username' not in data or 'email' not in data or 'password' not in data or 'last_name' not in data \
            or 'first_name' not in data or 'patronymic' not in data:
        return bad_request('must include username, email, password, last_name, first_name and patronymic fields')
